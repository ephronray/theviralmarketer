        ...
        <div class="card">
          ...
          <div class="card-body">
            <div class="tab-content">
              ...
              <div class="payment-errors alert alert-icon alert-danger alert-dismissible d-none mb-3">
              ...
              <form id="paymentFrm" method="post" action="<?=cn($module."/stripe/create_payment")?>">
                <div class="form-group">
                  <label class="form-label"><?=sprintf(lang("amount_usd"), getOption("currency_code",''))?></label>
...
Stripe.setPublishableKey("<?=getOption("stripe_publishable_key", '')?>");
