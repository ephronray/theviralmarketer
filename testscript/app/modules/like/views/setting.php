        ...
        <div class="col-md-6">
          <div class="form-group">
            ...
            <select class="form-control" name="speed" data-style="btn-outline-info">
              <option <?=(!empty($act) && get_value($act, "speed")=="auto")?"selected":""?> value="auto"><?=lang('auto')?> <?=sprintf(lang('x_requests_per_hour'),getOption('like_speed_auto', 5))?></option>
              <option <?=(!empty($act) && get_value($act, "speed")=="slow")?"selected":""?> value="slow"><?=lang('slow')?> <?=sprintf(lang('x_requests_per_hour'),getOption('like_speed_slow', 3))?></option>
              <option <?=(!empty($act) && get_value($act, "speed")=="medium")?"selected":""?> value="medium"><?=lang('medium')?> <?=sprintf(lang('x_requests_per_hour'),getOption('like_speed_medium', 4))?></option>
              <option  <?=(!empty($act) && get_value($act, "speed")=="fast")?"selected":""?> value="fast"><?=lang('fast')?> <?=sprintf(lang('x_requests_per_hour'),getOption('like_speed_fast', 8))?></option>
            </select>
          </div>
        </div>
