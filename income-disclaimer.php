...
$sql = "SELECT 
		  ...
		  FROM  `tbl_pages` 
		  WHERE  `page_name` =  'income-disclaimer' Limit 1";
...
?>
    ...
    <article class="content grid-page">
        <div class="title-block">
            <h3 class="title">Income Disclaimer</h3>
            <p class="title-description">Please Read Viral Marketer Income Disclaimer Carefully!!</p>
        </div>
