	...
	}else 
	{
		...
		if(count($result) == 2)
		{
			...
			if(!empty($landingPage))
			{
				...
				echo "<li> <iframe src=\"http://localhost/admin/landing_pages/".$landingPage['page_path'].'/?ref='.$_GET['ref']."\" style=\"position:fixed; top:0px; left:0px; bottom:0px; right:0px; width:100%; height:100%; border:none; margin:0; padding:0; overflow:hidden; z-index:999999;\">	</iframe></li>";
					exit();
			}
		}
	}
