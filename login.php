...
<html>
    ...
    <div class="wrapper fadeInDown">
        <div id="formContent">
            ...
            <div class="fadeIn first" style="margin: 20px 20px">
                ...
                <form role="form" method="POST" class="form-element" novalidate="" action="">
                    ...
                    <div class="form-group" style="margin-left: 30%">
                        <button type="submit" name="logIn" class="btn btn-lg btn-primary" style="width: 40%">Sign in</button>
                    </div>
            ...
            <!-- Remind Passowrd -->
            <div id="formFooter">
                <a class="underlineHover" href="faq.php" style="padding-right: 2px" >FAQ</a>

                <a class="underlineHover" href="terms-and-conditions.php" style="padding-right: 2px">Terms & Condition</a>

                <a class="underlineHover"href="privacy-policy.php" style="padding-right: 2px">Privacy policy</a>

                <a class="underlineHover" href="income-disclaimer.php" style="padding-right: 2px">Income Disclaimer</a>

                <a class="underlineHover" href="refund-policy.php" style="padding-right: 2px">Refund Policy</a>
            </div>
